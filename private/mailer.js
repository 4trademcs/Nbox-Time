...
const transporter = nodemailer.createTransport({
  ...
  //  * Para utilizar otro servicio de correo electrónico, como Yahoo o Outlook, se debe
...
// Definir el contenido del cuepro para el correo electrónico que  se desea enviar
const mailOptions = {
  from: "programadorphp2017@gmail.com",
  to: "csmichel8@gmail.com",
